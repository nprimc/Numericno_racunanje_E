...
equiPotX3R=list(map(lambda x: x*(-1), equiPotX3))
...
ForceLine1=LineOfForce(Path1, 130)
ForceLine2=LineOfForce(Path2, 110)
ForceLine3=LineOfForce(Path3, 105)
...
plot=[equiPotential0, equiPotential1, equiPotential2, equiPotential3, equiPotential0R, equiPotential1R, equiPotential2R, equiPotential3R, equiPotential4, equiPotential5, plotlyForceLine0, plotlyForceLine1, plotlyForceLine2, plotlyForceLine3, plotlyForceLine4, plotlyForceLine5, plotlyForceLine6, plotlyForceLine7, plotlyForceLine8,  points, tocka0, vektorE0, vektorE1, tocka1]

fig=go.Figure(data=plot, layout=layout)

py.plot(plot, filename='2 Pozitivna Naboja', auto_open=True)
