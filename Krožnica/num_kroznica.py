...
###Secont part of Equipotential line

equiPotX0R=list(map(lambda x: x*(-1), equiPotX0))
...
equiPotX1R=list(map(lambda x: x*(-1), equiPotX1))
...
###Secont part of Equipotential line (Y,Z components remain the same)

equiPotX2R=list(map(lambda x: x*(-1), equiPotX2))
...
'''
'''
Test if the incrementation of angle and radius works correctly, It does!
...
ForceLine0=LineOfForce(Path0, 150)
ForceLine1=LineOfForce(Path1, 100)
ForceLine2=LineOfForce(Path2, 100)
ForceLine3=LineOfForce(Path3, 100)
ForceLine4=LineOfForce(Path4, 100)
ForceLine5=LineOfForce(Path5, 100)
ForceLine6=LineOfForce(Path6, 100)
ForceLine7=LineOfForce(Path7, 100)
ForceLine8=LineOfForce(Path8, 100)
...
plot=[equiPotential0, equiPotential1, equiPotential2, equiPotential0R, equiPotential1R, equiPotential2R, equiPotential3, plotlyForceLine4, equiPotential5, plotlyForceLine0, plotlyForceLine1, plotlyForceLine2, plotlyForceLine3, plotlyForceLine4, plotlyForceLine5, plotlyForceLine6, plotlyForceLine7, plotlyForceLine8,  points, tocka0, vektorE0, vektorE1, tocka1]

fig=go.Figure(data=plot, layout=layout)

py.plot(plot, filename='Kroznica', auto_open=True)
